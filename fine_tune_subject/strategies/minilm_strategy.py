"""
all-MiniLM-L6-v2 training strategy for subject classification
Dedicated strategy for the all-MiniLM-L6-v2 sentence transformer model
Uses SVM classification with optimized parameters for this specific model
"""
...
class MiniLMTrainingStrategy(TrainingStrategy):
    """all-MiniLM-L6-v2 training strategy using SVM classification"""
    ...
    def get_default_params(self):
        return {
            ...
            'batch_size': 32,
            'classifier': 'svm',  # 'svm', 'logistic', 'knn'
