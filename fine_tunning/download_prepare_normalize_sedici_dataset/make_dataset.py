import pandas as pd
import  json
from constant import JSON_FOLDER,TXT_FOLDER,DATASET_WITH_TEXT_DOC,DATASET_WITH_METADATA_CHECKED
...
def add_text_input_to_dataset():
    ...
    write_to_json(JSON_FOLDER+DATASET_WITH_TEXT_DOC,dict_metadata,"utf-8")
